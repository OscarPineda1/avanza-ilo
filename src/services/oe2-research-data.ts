...
export function buildOe2ResearchData(routes = getPilotRoutes()) {
  ...
  return {
    ...
    services: routes.map((route) => ({
      ...
      startMinute: route.service.startMinute,
      endMinute: route.service.endMinute,
      headwayMinutes: route.service.headwayMinutes,
      dispatchReferenceKind: route.service.dispatchReferenceKind,
      dispatchReferenceMinute: route.service.dispatchReferenceMinute,
      timezone: route.service.timezone,
      source: route.service.source,
      sourceDate: route.service.sourceDate,
      evidenceStatus: 'supuesto operativo; no habilita ETA',
    })),
